package com.example.cms.Admin.Courses;
...
public class ManageCourseController implements Initializable {
    ...
    public void addCourse(ActionEvent actionEvent) {
        try {
            Parent fxml = FXMLLoader.load(HelloApplication.class.getResource("Admin/Courses/add-course.fxml"));
    ...
    public void updateCourse(ActionEvent actionEvent) {
        try {
            Parent fxml = FXMLLoader.load(HelloApplication.class.getResource("Admin/Courses/update-course.fxml"));
            manageCoursePane.getChildren().removeAll();
            manageCoursePane.getChildren().setAll(fxml);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void deleteCourse(ActionEvent actionEvent) {
        try {
            Parent fxml = FXMLLoader.load(HelloApplication.class.getResource("Admin/Courses/delete-course.fxml"));
            manageCoursePane.getChildren().removeAll();
            manageCoursePane.getChildren().setAll(fxml);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void showCourse(ActionEvent actionEvent) {
        try {
            Parent fxml = FXMLLoader.load(HelloApplication.class.getResource("Admin/Courses/show-course.fxml"));
            manageCoursePane.getChildren().removeAll();
            manageCoursePane.getChildren().setAll(fxml);
        } catch (IOException e) {
            e.printStackTrace();
