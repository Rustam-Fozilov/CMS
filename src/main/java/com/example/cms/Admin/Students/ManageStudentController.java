...
public class ManageStudentController implements Initializable {
    ...
    public void addStudent(ActionEvent actionEvent) {
        try {
            Parent fxml = FXMLLoader.load(HelloApplication.class.getResource("Admin/Students/add-student.fxml"));
    ...
    public void updateStudent(ActionEvent actionEvent) {
        try {
            Parent fxml = FXMLLoader.load(HelloApplication.class.getResource("Admin/Students/update-student.fxml"));
            manageStudentPane.getChildren().removeAll();
            manageStudentPane.getChildren().setAll(fxml);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void deleteStudent(ActionEvent actionEvent) {
        try {
            Parent fxml = FXMLLoader.load(HelloApplication.class.getResource("Admin/Students/delete-student.fxml"));
            manageStudentPane.getChildren().removeAll();
            manageStudentPane.getChildren().setAll(fxml);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void showStudent(ActionEvent actionEvent) {
        try {
            Parent fxml = FXMLLoader.load(HelloApplication.class.getResource("Admin/Students/show-student.fxml"));
            manageStudentPane.getChildren().removeAll();
            manageStudentPane.getChildren().setAll(fxml);
        } catch (IOException e) {
            e.printStackTrace();
